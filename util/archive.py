...
class Archive(object):
    ...
    def generate_query_url(self, lastname, country, state, recordtype, 
        ...
        """generate an url having query result
        """
...
class Parser(object):
    def num_of_records(self, html):
        """get how many results returns from a query by lastname, state, year
        """
        html = str(html)
...
if __name__ == "__main__":
    arc = Archive()
    url = arc.generate_query_url("Carlson", "US", "VA", 2, 2014, 0, 10, 1)
    print(url)